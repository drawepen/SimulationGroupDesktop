...
public:
    ...
    QWidget *widget_3;
    QLabel *label_13;
    QTableWidget *stateMapTable;
    QPushButton *addStateMapButton;
    QFrame *line;
    QFrame *line_2;
    ...
    void setupUi(QDialog *ModelSetting)
    {
        ...
        widget_2->setGeometry(QRect(0, 10, 331, 41));
        ...
        widget_3->setGeometry(QRect(0, 50, 331, 231));
        label_13 = new QLabel(widget_3);
        label_13->setObjectName(QString::fromUtf8("label_13"));
        label_13->setGeometry(QRect(10, 0, 54, 41));
        label_13->setWordWrap(true);
        stateMapTable = new QTableWidget(widget_3);
        if (stateMapTable->columnCount() < 4)
            stateMapTable->setColumnCount(4);
        QTableWidgetItem *__qtablewidgetitem = new QTableWidgetItem();
        stateMapTable->setHorizontalHeaderItem(0, __qtablewidgetitem);
        QTableWidgetItem *__qtablewidgetitem1 = new QTableWidgetItem();
        stateMapTable->setHorizontalHeaderItem(1, __qtablewidgetitem1);
        QTableWidgetItem *__qtablewidgetitem2 = new QTableWidgetItem();
        stateMapTable->setHorizontalHeaderItem(2, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        stateMapTable->setHorizontalHeaderItem(3, __qtablewidgetitem3);
        stateMapTable->setObjectName(QString::fromUtf8("stateMapTable"));
        stateMapTable->setGeometry(QRect(10, 40, 311, 181));
        stateMapTable->horizontalHeader()->setMinimumSectionSize(0);
        stateMapTable->horizontalHeader()->setDefaultSectionSize(76);
        stateMapTable->verticalHeader()->setMinimumSectionSize(30);
        addStateMapButton = new QPushButton(widget_3);
        addStateMapButton->setObjectName(QString::fromUtf8("addStateMapButton"));
        addStateMapButton->setGeometry(QRect(10, 60, 20, 30));
        line = new QFrame(cellMapping);
        line->setObjectName(QString::fromUtf8("line"));
        line->setGeometry(QRect(0, 10, 320, 2));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);
        line_2 = new QFrame(cellMapping);
        line_2->setObjectName(QString::fromUtf8("line_2"));
        line_2->setGeometry(QRect(0, 50, 320, 2));
        ...
        actionTable->setHorizontalHeaderItem(0, __qtablewidgetitem4);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        actionTable->setHorizontalHeaderItem(1, __qtablewidgetitem5);
    ...
    void retranslateUi(QDialog *ModelSetting)
    {
        ...
        QTableWidgetItem *___qtablewidgetitem = stateMapTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("ModelSetting", "\345\214\272\351\227\264", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = stateMapTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("ModelSetting", "\347\261\273\345\236\213", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = stateMapTable->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("ModelSetting", "\351\242\234\350\211\262", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = stateMapTable->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("ModelSetting", "\346\223\215\344\275\234", nullptr));
        addStateMapButton->setText(QCoreApplication::translate("ModelSetting", "\357\274\213", nullptr));
        ...
        ___qtablewidgetitem4->setText(QCoreApplication::translate("ModelSetting", "\350\241\214\344\270\272\350\247\204\345\210\231", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = actionTable->horizontalHeaderItem(1);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("ModelSetting", "\346\223\215\344\275\234", nullptr));
